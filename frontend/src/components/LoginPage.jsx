    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <p style={{ fontSize: '0.76rem', color: '#1e40af', fontWeight: 600, marginBottom: '0.4rem' }}>
            Existing Accutai Team Member Accounts:
          </p>
          <div style={{ display: 'flex', justifyContent: 'center', gap: '0.5rem', flexWrap: 'wrap' }}>
            <button
              type="button"
              onClick={() => {
                setEmail('soumyadeep.giri@accutai.com');
                setIsRegister(false);
              }}
              style={{
                fontSize: '0.74rem',
            ...
            >
              soumyadeep.giri@accutai.com
            </button>
            <button
              type="button"
              onClick={() => {
                setEmail('anjan.das@accutai.com');
                setIsRegister(false);
              }}
              style={{
                fontSize: '0.74rem',
